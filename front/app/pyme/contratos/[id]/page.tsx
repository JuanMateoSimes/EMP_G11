        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800 flex items-start gap-3 font-sans print:hidden">
              ...
              <div>
                <p className="font-semibold">Información Regulatoria</p>
                <p className="mt-0.5 text-blue-700 leading-normal">
                  Este contrato digital cumple con las normativas nacionales de transporte terrestre de granos. Al vincularlo con su carta de porte electrónica, se cruzará con el número registrado en esta previsualización para agilizar los despachos y auditorías de balanza.
                </p>
              </div>
            </div>
          </div>
